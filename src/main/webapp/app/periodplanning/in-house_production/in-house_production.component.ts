        ...
        this.teilService.query({
            ...
            for (i = 0; i < this.teils.length; i++) {
                ...
                if (this.teils[i].sicherheitsbestand !== undefined && this.teils[i].sicherheitsbestand !== null) {
                    ...
                    /*if (this.teils[i].vertriebswunsch !== undefined && this.teils[i].vertriebswunsch !== null) {
                        this.inhouse_anzeige_array[i].vertriebswunsch = this.teils[i].vertriebswunsch;
                    } else {
                        this.inhouse_anzeige_array[i].vertriebswunsch = 0;
                    }*/
            }
        ...
        this.teilService.query({
            ...
            for (i = 0; i < this.inhouse_anzeige_array.length; i++) {
                this.teil = this.teile.find((teil) => (teil.nummer === this.inhouse_anzeige_array[i].nummer));
                    ...
                    // Replace with warteliste material and with real amount
