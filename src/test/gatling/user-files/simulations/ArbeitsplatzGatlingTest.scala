...
/**
 * Performance test for the Arbeitsplatz entity.
 */
class ArbeitsplatzGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Arbeitsplatz entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all arbeitsplatzs")
            .get("/api/arbeitsplatzs")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created arbeitsplatz")
                .get("${new_arbeitsplatz_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created arbeitsplatz")
            .delete("${new_arbeitsplatz_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
