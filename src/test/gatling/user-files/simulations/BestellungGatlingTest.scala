...
/**
 * Performance test for the Bestellung entity.
 */
class BestellungGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Bestellung entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created bestellung")
                .get("${new_bestellung_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created bestellung")
            .delete("${new_bestellung_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
