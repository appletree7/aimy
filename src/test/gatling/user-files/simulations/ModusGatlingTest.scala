...
/**
 * Performance test for the Modus entity.
 */
class ModusGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Modus entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created modus")
                .get("${new_modus_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created modus")
            .delete("${new_modus_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
